		...
		<div id="content" class="site-content" role="main">
			...
			<article id="post-0" class="post error404 not-found">
				...
				<div class="entry-content">
					<p><?php _e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'gumbo' ); ?></p>
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'gumbo' ), convert_smilies( ':)' ) ) . '</p>';
