...
add_action('woocommerce_before_main_content', 'woocommerce_gumbo_before_content', 10);
add_action('woocommerce_after_main_content', 'woocommerce_gumbo_after_content', 20);

if (!function_exists('woocommerce_gumbo_before_content')) {
	function woocommerce_gumbo_before_content() {
		?>
...
if (!function_exists('woocommerce_gumbo_after_content')) {
	function woocommerce_gumbo_after_content() {
		?>
...
add_action('gumbo_homepage_content', 'gumbo_product_categories', 10);
add_action('gumbo_homepage_content', 'gumbo_featured_products', 10);
add_action('gumbo_homepage_content', 'gumbo_recent_products', 30);

function gumbo_product_categories() {
	global $woo_options;
...
function gumbo_featured_products() {
	global $woo_options;
...
function gumbo_recent_products() {
	global $woo_options;
